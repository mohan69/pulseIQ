         ...
         <div className="no-print sticky top-0 z-50 border-b border-border bg-white/90 backdrop-blur-md">
           <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
             <div className="flex items-center gap-3">
               ...
               <div>
                  <span className="font-bold text-foreground">RightSense Diagnostic Report</span>
              ...
              <div className="space-y-2">
                ...
                <div className="mt-6 text-center max-w-2xl mx-auto">
                  <p className="text-sm text-muted leading-relaxed">
                    {DIAGNOSTIC_POSITIONING} The scope includes operating,
                    compliance and standards, vendor/supplier,
                    prequalification, statutory documentation, and AI
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                [
                  ...
                  "ISO readiness, technical standards mapping, statutory documents, audit evidence, and customer prequalification gaps.",
                ],
                [
                  "Vendor / supplier ecosystem readiness",
                  "Supplier qualification, subcontractor governance, vendor registration, and partner documentation gaps.",
                ],
                [
                  "AI governance readiness",
                  "Human validation, source traceability, prompt/output review, approvals, policy controls, and audit trails.",
                ],
              ].map(([title, detail]) => (
                <div
                  key={title}
