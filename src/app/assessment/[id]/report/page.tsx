...
export default function ReportPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="no-print sticky top-0 z-50 border-b border-border bg-white/80 backdrop-blur-md">
      ...
      <main className="max-w-5xl mx-auto px-6 py-10 space-y-10">
        {/* Report Cover Header */}
        <div className="text-center border-b border-border pb-10">
          <div className="inline-flex items-center gap-2 rounded-full bg-accent-muted px-4 py-1.5 text-sm text-accent font-medium mb-6">
          ...
          <h2 className="text-2xl text-foreground-secondary font-semibold">{profile.companyName}</h2>
          ...
          <div className="mt-6 text-xs text-muted">
            Generated by PulseIQ | RightSense Technologies Pvt Ltd
          </div>
        </div>
        ...
        <section className="print-break">
          ...
          <div className="space-y-2">
            {cockpit.topBottlenecks.map((b, i) => (
              <div
                key={i}
                className="flex items-start gap-3 p-3 rounded-xl bg-error-muted border border-error/10 text-sm"
              >
              ...
              <div key={phase.phase}>
                ...
                <div className="space-y-2">
                  {phase.milestones.map((m) => (
                    <div
                      key={m.id}
                      className="p-3 rounded-xl border border-border text-sm"
                    >
        ...
        <section>
          ...
          <div className="space-y-2">
            {cockpit.executiveActions.map((action, i) => (
              <div
                key={i}
                className="flex items-start gap-3 p-3 rounded-xl bg-accent-muted text-sm"
              >
